import {
  ...
  CalendarDays, Shield, Lock, Crown, Video, HardDriveUpload, ScanFace, Sparkles, Archive, IdCard,
} from "lucide-react";
...
const navItems = [
  ...
  { title: "Bulk ID Cards", url: "/school/id-cards", icon: IdCard },
  ...
  { title: "AI Report Card", url: "/school/ai-report-card", icon: Sparkles },
